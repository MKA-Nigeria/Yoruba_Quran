...
public class PDFView extends RelativeLayout {
    ...
    public void jumpTo(int page, boolean withAnimation) {
        if (swipeVertical) {
            float toY = -page * toCurrentScale(getOptimalPageHeight(page));
            if (withAnimation) {
            ...
            float toX = -page * toCurrentScale(getPageActualWidth(page));
            if (withAnimation) {
    ...
    private void drawPart(Canvas canvas, PagePart part) {
        ...
        if (swipeVertical)
            localTranslationY = toCurrentScale(part.getUserPage() * getOptimalPageHeight(part.getUserPage()));
        else
            localTranslationX = toCurrentScale(part.getUserPage() * getOptimalPageWidth(part.getUserPage()));
    ...
    public void loadComplete(PdfDocument pdfDocument) {
        ...
        // We used to assume all the pages are the same size
