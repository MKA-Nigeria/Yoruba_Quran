...
public class FileUtils {
    ...
    private void initFilesFolder() {
        filesFolder = new File(Environment.getExternalStorageDirectory() + Constants.TEMP_FOLDER_NAME);
        if (!filesFolder.exists()) {
            filesFolder.mkdirs();
            initNoMediaFile(Environment.getExternalStorageDirectory() + Constants.TEMP_FOLDER_NAME, ".nomedia");
        }
    }
    ...
    public File createFileIfNotExist(String fileUrlString) {
        ...
        String fileName = fileUri.getLastPathSegment() + Constants.FILE_TYPE;
